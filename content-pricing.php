<?php
/**
 * The content template for the Pricing Page.
 */
?>
...
<div class="pricing-table__list-item--price">$125</div></li>
...
<div class="pricing-table__list-item--time">1 hour</div>
<div class="pricing-table__list-item--price">$150</div></li>
	<li class="pricing-table__odd">
...
<div class="pricing-table__list-item--time">1 hour</div>
<div class="pricing-table__list-item--price">$175</div></li>
</ul>
</div>
</section>
...
<div class="pricing-table__list-item--price">$200</div></li>
	<li class="pricing-table__even">
...
<div class="pricing-table__list-item--price">$250</div></li>
	<li class="pricing-table__odd">
...
<div class="pricing-table__list-item--price">$1300</div></li>
	<li class="pricing-table__even">
...
<div class="pricing-table__list-item--price">$1850</div></li>
	<li class="pricing-table__odd">
...
<div class="pricing-table__list-item--price">starts at $2000</div></li>
</ul>
</div>
</section>
<div class="pricing__footnotes">Additional Information
