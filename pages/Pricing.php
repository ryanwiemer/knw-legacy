	...
	<div class="pricing-table">
	  <h3 class="pricing-table__header">Portrait Packages</h3>
		<ul class="pricing-table__list">
			<li class="pricing-table__top-row"><h4 class="pricing-table__list-item--description">Session Description</h4><h4 class="pricing-table__list-item--price">Price</h4></li>
